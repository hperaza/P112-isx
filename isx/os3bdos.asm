...
;
;  *******************************************************************
;  * This BDOS module has been modified to match the version used by *
;  * the ISIS-II emulator V1.4. The changes are summarized below:    *
;  *                                                                 *
;  *  - Removed a small unused section of code                       *
;  *  - Modified the close function to save the unused bytes count   *
;  *  - Inlined the compext function in the search code.             *
;  *                                                                 *
;  *******************************************************************
;
on	equ	0ffffh
...
searchn:
	...
	searchnext:
		...
		searchext:
			...
			lda extmsk! cma! mov b,a
			;B has negated form of extent mask
			ana m! mov c,a ;low bits removed from C
			ldax d ;directory character to A
...
close:
	...
	dmset:
		...
		inx d! inx h! ldax d! mov m,a ;buff(ubytes) := fcb(ubytes)
		;update directory record count field
		lxi b,(reccnt-ubytes)! dad b! xchg! dad b
